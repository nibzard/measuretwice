...
| Outcomes | [reports/outcomes.json](reports/outcomes.json) | The aggregate order, every check outcome, the completion statuses, and the case references with and without one host snapshot reference. |
